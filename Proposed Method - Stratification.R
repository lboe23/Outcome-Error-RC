...
for(iter in 1:NSIM){
  ...
  loglikStrat <- function(parmsS,Dm1,Dm2,Dm3,Dm4,Xmat1,Xmat2,Xmat3,Xmat4){
    ...
    strataLL<-loglikfunction(parm=parmi1,Dm=Dm1,Xmat=Xmat1)+loglikfunction(parm=parmi2,Dm=Dm2,Xmat=Xmat2)+loglikfunction(parm=parmi3,Dm=Dm3,Xmat=Xmat3)+loglikfunction(parm=parmi4,Dm=Dm4,Xmat=Xmat4)
    return(strataLL)
  }
